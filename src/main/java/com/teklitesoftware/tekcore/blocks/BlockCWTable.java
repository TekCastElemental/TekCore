...
public class BlockCWTable extends Block {
	public BlockCWTable() {
		super(Material.WOOD);
		setUnlocalizedName(Reference.TekCoreBlocks.CWT.getUnlocalizedName());
		setRegistryName(Reference.TekCoreBlocks.CWT.getRegistryName());
    ...
    public boolean canPlaceTorchOnTop(IBlockState state, IBlockAccess world, BlockPos pos)
    {
        ...
        {
            return this instanceof BlockCWTable || this == ModBlocks.cwtable;
        }
    }
	public Block getItemDropped(int metadata, Random rand, int fortune) {
		return ModBlocks.cwtable;
	}
}
