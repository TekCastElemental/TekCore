...
public class ModCrafting {
	...
	public static void register() {
		// Shapeless Recipes
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.Ris), Items.STICK, Items.IRON_INGOT);
		...
		// Smelting Recipes
		GameRegistry.addSmelting(ModBlocks.sapphireore, new ItemStack(ModItems.singot), 0.1f);
