...
public class BiomeBurntScar extends Biome {

	private static final WorldGenTaiga1 PINE_GENERATOR = new WorldGenTaiga1();
    private static final WorldGenTrees OAK_GENERATOR = new WorldGenTrees(false);
    public final BiomeBurntScar.Type type;

    public BiomeBurntScar(BiomeBurntScar.Type typeIn, Biome.BiomeProperties properties)
    {
        super(properties);
        this.type = typeIn;
        ...
        this.setRegistryName(Reference.TCbiomes.BURNT.getRegistryName());
        
        
        
        
        if (this.type == BiomeBurntScar.Type.FLOWER)
        {
            this.theBiomeDecorator.treesPerChunk = 1;
        ...
        if (this.type == BiomeBurntScar.Type.NORMAL)
        {
            this.spawnableCreatureList.add(new Biome.SpawnListEntry(EntityWolf.class, 5, 4, 4));
        }

        if (this.type == BiomeBurntScar.Type.ROOFED)
        {
            this.theBiomeDecorator.treesPerChunk = 1;
            this.theBiomeDecorator.flowersPerChunk = 0;
            this.theBiomeDecorator.grassPerChunk = 1;
    ...
    {
		return (WorldGenAbstractTree)(rand.nextInt(3) > 0 ? this.OAK_GENERATOR : super.genBigTreeChance(rand));
   ...
   /* public BlockFlower.EnumFlowerType pickRandomFlower(Random rand, BlockPos pos)
    ...
    /*    if (type != BiomeBurntScar.Type.FLOWER)
        {
